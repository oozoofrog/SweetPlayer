...
class Movie {
    ...
    init(device: MTLDevice, pixelFormat: MTLPixelFormat, colorMatrix: ColorMatrix, videoRatio: CGSize, screenRatio: CGSize) {
        self.device = device
    ...
    func render(view: MTKView, data: VideoData, clearColor: MTLClearColor = MTLClearColorMake(0, 0, 0, 1)) {
...
struct ColorMatrix {
    ...
    static let yuvK: [Float] = [-32 / 255.0, -0.5, -0.5, 0]
